...
bin/test: bin build test.cc build/bitstream.o build/lzw.o build/gif_processor.o
	g++ $(CXXFLAGS) test.cc build/bitstream.o build/lzw.o build/gif_processor.o -o bin/test

build/lzw.o: lzw.cc lzw.hh bitfield.hh bitstream.hh
	g++ $(CXXFLAGS) -c lzw.cc -o build/lzw.o

build/gif_processor.o: gif_processor.cc gif_processor.hh bitstream.hh lzw.hh
